...
('root', 'DrinkChallengeApp', 'challenge_user_data', '{\"sorted_col\":\"`challenge_user_data`.`finish_time`  ASC\"}', '2019-12-13 01:48:30'),
('root', 'barbuddy', 'bardata', '{\"sorted_col\":\"`deal_dow`  DESC\"}', '2019-08-28 23:10:59'),
('root', 'barbuddy', 'eventdata', '{\"sorted_col\":\"`event_date`  ASC\"}', '2019-10-09 22:28:24');
...
('root', '2019-12-13 01:41:25', '{\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `Humidity_data` DEFAULT CHARACTER SET utf16 COLLATE utf16_bin;
USE `Humidity_data`;
...
CREATE TABLE `humidity_data` (
  ...
  `dateheure` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
